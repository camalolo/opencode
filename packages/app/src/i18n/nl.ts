export const dict = {
  ...
  "session.messages.resyncing": "Verbinding hersteld — berichten worden opnieuw gesynchroniseerd…",
  "session.messages.history.windowed": "Oudere berichten zijn niet geladen",
  "session.messages.history.loadAll": "Volledige geschiedenis laden",
  "session.messages.history.loadingAll": "Volledige geschiedenis wordt geladen…",
