...
export const dict = {
  ...
  "session.messages.resyncing": "连接已恢复 — 正在重新同步消息…",
  "session.messages.history.windowed": "较早的消息尚未加载",
  "session.messages.history.loadAll": "加载完整历史记录",
  "session.messages.history.loadingAll": "正在加载完整历史记录…",
