export const dict = {
  ...
  "session.messages.resyncing": "接続が回復しました — メッセージを再同期中…",
  "session.messages.history.windowed": "古いメッセージは未読み込みです",
  "session.messages.history.loadAll": "全履歴を読み込む",
  "session.messages.history.loadingAll": "全履歴を読み込み中…",
