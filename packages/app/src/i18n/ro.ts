export const dict = {
  ...
  "session.messages.resyncing": "Conexiune restabilită — resincronizare mesaje…",
  "session.messages.history.windowed": "Mesajele mai vechi nu sunt încărcate",
  "session.messages.history.loadAll": "Încarcă istoricul complet",
  "session.messages.history.loadingAll": "Se încarcă istoricul complet…",
